...
export function RobuxIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 2L24.5 8V20L14 26L3.5 20V8L14 2Z" fill="currentColor" fillOpacity="0.15" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M14 8L20.5 11.5V18.5L14 22L7.5 18.5V11.5L14 8Z" fill="currentColor" fillOpacity="0.3"/>
      <path d="M14 2V8M24.5 8L20.5 11.5M24.5 20L20.5 18.5M14 26V22M3.5 20L7.5 18.5M3.5 8L7.5 11.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function RobuxHexFlat({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L21 7V17L12 22L3 17V7L12 2Z" fillOpacity="0.2"/>
      <path d="M12 6L17 9V15L12 18L7 15V9L12 6Z" fillOpacity="0.5"/>
      <path d="M12 2V6M21 7L17 9M21 17L17 15M12 22V18M3 17L7 15M3 7L7 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
